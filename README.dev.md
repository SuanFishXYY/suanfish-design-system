...
├── references/              # 50 份规范（含 3 份独立规则集 15/16/19 + 3 份审核制度 28/29/30 + 5 份横向规范 31-35 + 6 份 AI-native 36-41 + 2 份品牌/i18n 42-43 + 2 份通用组件/基础控件 44-45 + 1 份设计美学 46 + 1 份哲学映射 47 + 1 份议会推演 48） + 3 份附录（component-patterns / interaction-patterns / steps-schema）
