...
> v4.2 起官方支持 Google Antigravity 一键安装。
...
安装器会在 `~/.antigravity/skills/suanfish-design-system` 建立 symlink, Antigravity 启动后自动发现 54 个 agent + 50 份规范 + 420 思想家板凳。
...
Antigravity 的 Gemini 议程会自动加载本 skill 的 SKILL.md, 启动 v4.2 议会六步协议。
...
期望回复包含: `v4.2 三大类 4:4:4 均权议会 · 12 位 Tier 0 (4 哲+4 艺+4 音)`。
